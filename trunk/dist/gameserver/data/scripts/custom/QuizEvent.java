...
public class QuizEvent
{
	...
	private static void announceStart()
	{
		...
		Announcements.getInstance().announceToAll("Get Ready! L2OCeany is ready to reward you!");
	...
	{
		_quizRunning = false;
		Announcements.getInstance().announceToAll("The Quiz Event is over! Play with us! We <3 L2OCeany");
		announced = 0;
		_status = STATUS_NOT_IN_PROGRESS;
	...
	private static void giveReward()
	{
		for (Player p : _players.keySet())
		{
			...
			{
				p.sendMessage("Your answer was correct! L2OCeany Reward you with 1 GCM!");
