...
//			player.getCounters().repeatableQuestsCompleted++;
	...
	public double getRateQuestsDrop()
	{
		...
		if (Config.QUEST_REWARD_RATES.containsKey(getQuest().getQuestIntId()))
			return Config.RATE_QUESTS_DROP * Bonus * Config.QUEST_REWARD_RATES.get(getQuest().getQuestIntId());
	...
	public double getRateQuestsReward()
	{
		...
		if (Config.QUEST_REWARD_RATES.containsKey(getQuest().getQuestIntId()))
			return Config.RATE_QUESTS_REWARD * Bonus * Config.QUEST_REWARD_RATES.get(getQuest().getQuestIntId());
